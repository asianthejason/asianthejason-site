...
- Runs award persistent Data Cores: one per five completed waves plus two per defeated boss. The Archive spends them on permanent tower doctrines, and one unlocked doctrine may be equipped before each run. Doctrines are strategic sidegrades with matching drawbacks rather than direct permanent power increases.
