...
- Targets: first, last, strongest, closest, unslowed. Level-five towers choose one permanent evolution.
...
- Abilities consume both energy and scrap: overcharge (8s / 55s cooldown), EMP (2.5s / 65s), aimed orbital strike (130 radius / 80s), repair (5 integrity / 90s), and scrap magnet (double kill rewards for 10s / 70s). Prices increase every wave: energy by 3.5% and scrap by 2.5% of each ability's base cost per wave. Orbital charges only when its target is confirmed.
